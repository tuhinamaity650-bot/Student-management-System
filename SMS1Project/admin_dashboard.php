...
<head>
	...
	<?php
		session_start();
		$name = "";
		$connection = mysqli_connect("localhost", "root", "", "SMS", 4306);
	?>
</head>
<body>
	<div id="header"><br>
	...
	<span id="top_span"><marquee>Note:- This portal is open till 31 March 2025...Plz edit your information, if wrong.</marquee></span>
	<div id="left_side">
		<br><br><br>
